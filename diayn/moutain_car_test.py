...
def plot_results(path):
    ...
    plt.figure()
    plt.plot(pretrained.rewards, label = "pretrained")
    plt.plot(baseline.rewards, label = "baseline")
    plt.legend()
    plt.show()
...
if __name__ == "__main__":
    ...
    if k<1 :
        path = "tests_" + str(datetime.datetime.today()).replace(":", "-").replace(" ", "-") + "\\"
        ...
        path = "tests_2019-02-10-18-07-14.456659\\"
